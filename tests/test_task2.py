...
def test_output_is_list():
    minimum, maximum, quantity = random.randint(-100, 100), \
...
def test_quantity_greater_or_equals_returns_list_with_all_elements(minimum, maximum, quantity):
...
def test_quantity_less_than_returns_list_with_fewer_elements(minimum, maximum, quantity):
